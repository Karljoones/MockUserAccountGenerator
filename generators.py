...
def generate_random_name(generation_count = None):
    names_first_file = open('data/names_first.txt', 'r')
    names_last_file = open('data/names_last.txt', 'r')
...
def generate_email_address(names_for_emails):
    domains_list_file = open('data/domains.txt', 'r')
...
def random_country_and_locale(count = None):
    countries_and_locales_list = list(csv.reader(open('data/countries_and_locales.csv', 'r')))
